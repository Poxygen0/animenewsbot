...
def setup_logger(
    ...
    max_bytes: int = config.logging.log_max_bytes,
    ...
    logger.setLevel(logging.DEBUG if config.settings.debug else logging.INFO)
    ...
    if config.settings.debug:
        ...
        for noisy_name in config.logging.noisy_loggers:
